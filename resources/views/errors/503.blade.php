...
<style>
    ...
    .error-page .error-code { font-family: 'Space Grotesk', sans-serif; font-size: 6rem; font-weight: 700; line-height: 1; color: #0891b2; margin-bottom: 0.5rem; }
...
@section('content')
    <div class="error-page">
        ...
        <h1 class="error-title">{{ $content['title'] ?? 'Bảo trì' }}</h1>
        <p class="error-message">{{ $content['message'] ?? 'Hệ thống đang bảo trì. Vui lòng quay lại sau.' }}</p>
